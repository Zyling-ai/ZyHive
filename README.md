...
[![Version](https://img.shields.io/badge/version-26.8.1v10-brightgreen.svg)](CHANGELOG.md)
...
> **发布状态**
> 当前公开稳定版为 `26.8.1v10`，正式 Release 必须通过首次设置、Web 渠道、确定性对话、后台任务、Goal/Cron、持久化、旧版更新和更新后健康回滚全流程测试。
