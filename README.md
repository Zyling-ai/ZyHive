...
[![Version](https://img.shields.io/badge/version-26.8.1v12-brightgreen.svg)](CHANGELOG.md)
...
> **发布状态**
> 当前公开稳定版为 `26.8.1v12`，正式 Release 必须通过核心旅程、完整备份恢复、旧版更新、健康回滚，以及 SBOM、签名、构建来源和发布后安装验证。
