...
[![Version](https://img.shields.io/badge/version-26.8.1v11-brightgreen.svg)](CHANGELOG.md)
...
> **发布状态**
> 当前公开稳定版为 `26.8.1v11`，正式 Release 必须通过首次设置、核心任务、持久化、完整备份破坏恢复、旧版更新和更新后健康回滚全流程测试。
