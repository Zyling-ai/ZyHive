...
> 发布链基线已经恢复，但这不等于产品可靠性建设完成。下一阶段仍需补齐核心用户旅程 E2E、完整备份恢复、SBOM、签名和分支保护。
...
- 部分完成：官网重构已部署但仓库改动尚未推送；E2E 已验证安装、升级、备份和错误校验和，但尚未覆盖新进程健康失败后的自动恢复与完整备份恢复；
- 未完成：`main` 分支保护、连续三个受保护提交、Node.js 22/24 迁移、完整核心旅程 E2E、SBOM、签名和构建来源证明。
