...
> 文档状态：执行基线
> 制定日期：2026-07-31
> 最近复核：2026-08-01（当前稳定版 `26.8.1v7`）
> 适用周期：未来 12 个月
...
- 制定时正式版停在 `26.5.16v1` 且 CI 失败；截至 2026-08-01 已发布 `26.8.1v7` 并恢复 CI、安装更新门禁及更新后健康回滚；
...
- 当前公开稳定版为 `26.8.1v7`，已恢复主分支 CI、四平台产物、校验和及严格安装更新与健康回滚全流程门禁；
